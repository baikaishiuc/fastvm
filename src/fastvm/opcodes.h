...
const char *get_opname(OpCode opc);		///< Convert an OpCode to the name as a string
OpCode get_opcode(const char *nm);		///< Convert a name string to the matching OpCode

OpCode get_booleanflip(OpCode opc, bool *reorder);	///< Get the complementary OpCode
